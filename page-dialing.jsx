...
(function(){
  ...
  // ────────────────────────────────────────────────────────────────────────
  function PageDialing({ onCall, role = "rep", defaultMode }) {
    // Dialing is the power-dialer cockpit. No sub-modes — Deals/Follow-ups
    // live in their own surfaces (Pipeline / Today). This keeps the dial loop
    // uncluttered and on a single screen.
    return (
      <div className="page-pad">
        <div className="page-h">
          <div>
            <div className="page-title">Dialing</div>
  ...
  window.PageDialing = PageDialing;
})();
