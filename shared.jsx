...
// had grown to 7+ entries per role with overlapping surfaces (Floor, CRM, Lead
// Drip, Quote Tool, Messages, Leaderboard) that competed for attention. The
// new shape collapses each role to its highest-frequency surfaces. Pages
// removed from the sidebar are NOT deleted; they remain reachable via:
//   • Direct deep-link (app.jsx still resolves the case)
//   • /lab tile grid (super_admin only — see PageLab below)
