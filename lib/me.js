...
(function () {
  ...
  function isPlatformSuper(me) {
    return !!(me && (me.is_super_admin === true || me.role === "super_admin"));
  }
  window.canSeeFleet = function () {
    const me = window.me();
    return me && (isPlatformSuper(me) || me.role === "owner" || me.role === "admin");
  };
  window.canSeeTeam = function () {
    const me = window.me();
    return me && (isPlatformSuper(me) || me.role === "owner" || me.role === "admin" || me.role === "manager");
  };
