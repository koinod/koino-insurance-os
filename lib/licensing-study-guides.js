...
GUIDES['nj_life_producer'] = {
  i_types_of_policies: UNIFORM_SECTIONS.i_types_of_policies,
  ii_policy_riders_provisions_options_and_exclusions: UNIFORM_SECTIONS.ii_life_provisions_riders_options_and_exclusions,
  iii_completing_the_application_underwriting_and_delivering_the_policy: UNIFORM_SECTIONS.iii_completing_the_application_underwriting_and_delivering_the_policy,
  iv_taxes_retirement_and_other_insurance_concepts: UNIFORM_SECTIONS.iv_retirement_tax_and_other_insurance_concepts,
  v_new_jersey_laws_rules_and_regulations_common_to_life_accident_and_health_property_and_casualty_insurance: {
    title: 'NJ LAWS & REGULATIONS (COMMON)',
    subtitle: 'N.J.S.A. Title 17 & 17B · DOBI Commissioner Powers · Licensing & General Standards',
    blocks: [
      { type: 'heading', text: 'Commissioner & Department Powers' },
      { type: 'table', rows: [
          { label: 'DOBI Commissioner', value: 'Broad Powers', description: 'Enforces insurance laws, conducts hearings, issues subpoenas, and adopts rules.' },
          { label: 'Notice & Hearing', value: '10 Days Notice', description: 'Before suspending or revoking a license, the Commissioner must provide at least 10 days notice and hold a hearing.' },
          { label: 'General Penalties', value: 'Up to $5,000 / $10,000', description: 'First violation up to $5,000; subsequent violations up to $10,000 per occurrence.' }
      ]},
      { type: 'heading', text: 'Licensing & Continuing Education (CE)' },
      { type: 'table', rows: [
          { label: 'Prelicensing', value: '20 Hours', description: 'Required prelicensing education per line of authority (Life or Health).' },
          { label: 'CE Requirement', value: '24 Hours / 2 Years', description: 'Producers must complete 24 hours of CE every 2 years, including at least 3 hours of Ethics.' },
          { label: 'License Renewal', value: 'Biennial', description: 'Licenses expire biennially on the last day of the producer\'s birth month.' },
          { label: 'Temporary Work Authority', value: '60 Days Max', description: 'Issued after passing exam and submitting fingerprints, valid for up to 60 days.' },
          { label: 'Disabled Producer', value: 'Temporary License', description: 'Valid for up to 180 days to spouse, next of kin, or administrator without exam.' }
      ]},
      { type: 'heading', text: 'Trade Practices & Standards of Conduct' },
      { type: 'table', rows: [
          { label: 'Commingling', value: 'Strictly Prohibited', description: 'Producer must establish a trust account and cannot mix client premiums with personal funds.' },
          { label: 'Address Change', value: '30 Days Notice', description: 'Must notify DOBI within 30 days of changing business, residence, or email address.' },
          { label: 'Business Names', value: 'DOBI Approval', description: 'Fictitious or trade names must be approved by and registered with DOBI before use.' },
          { label: 'Information Privacy', value: 'NJSA 17:23A / HITECH', description: 'Strict limits on sharing consumer nonpublic financial and health info without consent.' },
          { label: 'Guaranty Association', value: 'Title 17 Chapter 30A', description: 'Protects policyholders up to $500,000 if an admitted insurer becomes insolvent.' }
      ]}
    ]
  },
  vi_new_jersey_laws_rules_and_regulations_pertinent_to_life_and_regulations: {
    title: 'NJ LAWS & REGULATIONS (LIFE & ANNUITY)',
    subtitle: 'N.J.S.A. Title 17B · N.J.A.C. Title 11 · Replacement, Disclosures & Annuity Suitability',
    blocks: [
      { type: 'heading', text: 'Life Insurance Marketing & Disclosures' },
      { type: 'table', rows: [
          { label: 'Replacement Rules', value: 'N.J.A.C. 11:4-2', description: 'Agent must submit a signed Replacement Notice and comparative information. Existing carrier must be notified immediately.' },
          { label: 'Free Look (Replacement)', value: '30-Day Window', description: 'NJ mandates a 30-day free look period for replacement policies (standard is 10 days).' },
          { label: 'Buyer\'s Guide', value: 'At Point of Sale', description: 'Insurers must provide a DOBI-approved Buyer\'s Guide and Policy Summary to applicants prior to accepting premium.' },
          { label: 'Twisting', value: 'Class A Misdemeanor', description: 'Illegal to make misleading comparisons to induce policyholders to drop/replace an existing policy.' }
      ]},
      { type: 'heading', text: 'Annuity & Life Suitability (Bulletin 09-06)' },
      { type: 'table', rows: [
          { label: 'Suitability Standard', value: 'NAIC Model 275', description: 'Producers must have reasonable grounds to believe an annuity recommendation is suitable based on client\'s age, income, and goals.' },
          { label: 'Mandated Training', value: '4-Hour Course', description: 'One-time 4-hour NAIC Best Interest training required before selling any annuity product.' },
          { label: 'Use of Designations', value: 'Strictly Regulated', description: 'Illegal to use fake or misleading senior certifications (e.g. Certified Senior Advisor) to imply special expertise.' }
      ]},
      { type: 'heading', text: 'NJ Life Policy Provisions' },
      { type: 'table', rows: [
          { label: 'Incontestability', value: '2-Year Limit', description: 'Life policies become incontestable after being in force for 2 years during the insured\'s lifetime.' },
          { label: 'Suicide Exclusion', value: '2-Year Limit', description: 'DOBI permits exclusion of death by suicide only within the first 2 years; premiums must be refunded.' },
          { label: 'Grace Period', value: '30 Days Min', description: 'Standard grace period of 30 days or 1 month is required for all life policies.' }
      ]}
    ]
  }
};
