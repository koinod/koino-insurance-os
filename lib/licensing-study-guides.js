...
const GUIDES = {
  /* ══════════════════════════════════════════════════════════
     ALABAMA LIFE PRODUCER
     ══════════════════════════════════════════════════════════ */
  al_life_producer: {
    al_insurance_regulation: {
      title: "ALABAMA INSURANCE REGULATION",
      subtitle: "Alabama Insurance Code · DOI authority · licensing & CE · Guaranty Association",
      blocks: [
        { type: "heading", text: "Alabama Regulatory Laws" },
        { type: "table", rows: [
          { label: "Licensing & CE", value: "24 hours / 2 years", description: "24 CE hours including 3 hours of Ethics biennially." },
          { label: "Unfair Trade Practices", value: "Rebating & Twisting prohibited", description: "Alabama Unfair Trade Practices Act." },
          { label: "Guaranty Association", value: "State Protection Fund", description: "Protects policyholders against insolvent insurers. Sales mention strictly illegal." }
        ]}
      ]
    },
    general_insurance_concepts: {
      title: "GENERAL INSURANCE CONCEPTS (ALABAMA)",
      subtitle: "Contract mechanics · insurable interest · risk management",
      blocks: [
        { type: "heading", text: "Core Concepts" },
        { type: "table", rows: [
          { label: "Contract Law", value: "Adhesion & Aleatory", description: "Standard contract principles." },
          { label: "Insurable Interest", value: "Required at inception", description: "Must exist at time of application." }
        ]}
      ]
    },
    life_insurance_products_and_provisions: {
      title: "AL LIFE PRODUCTS & PROVISIONS",
      subtitle: "Standard provisions · 10-day free look · nonforfeiture",
      blocks: [
        { type: "heading", text: "Standard Provisions" },
        { type: "table", rows: [
          { label: "Free Look Period", value: "10 days (30 replacement)", description: "Unconditional examination right for full refund." },
          { label: "Grace Period", value: "31 days", description: "31-day grace period." }
        ]}
      ]
    },
    annuities_and_federal_tax: {
      title: "ANNUITIES & FEDERAL TAX (ALABAMA)",
      subtitle: "Annuity principles · NAIC Best Interest · MEC rules · 1035 exchange",
      blocks: [
        { type: "heading", text: "Annuity & Tax Principles" },
        { type: "table", rows: [
          { label: "Best Interest Standard", value: "NAIC Model", description: "Mandatory annuity suitability rules." },
          { label: "Tax-Free Death Benefit", value: "100% Tax-Free", description: "Death proceeds non-taxable to beneficiary." }
        ]}
      ]
    },
    master_numbers_drill: {
      title: "ALABAMA MASTER NUMBERS DRILL",
      subtitle: "Key numbers and time periods for Alabama Life Producer exam",
      blocks: [
        { type: "heading", text: "Alabama Numbers" },
        { type: "table", rows: [
          { label: "Passing Score", value: "70%", description: "Minimum passing score." },
  ...
  /* ══════════════════════════════════════════════════════════
     ALASKA LIFE PRODUCER
     ══════════════════════════════════════════════════════════ */
  ak_life_producer: {
    ak_insurance_regulation: {
      title: "ALASKA INSURANCE REGULATION",
      subtitle: "Alaska Insurance Code · DOI authority · licensing & CE · Guaranty Association",
      blocks: [
        { type: "heading", text: "Alaska Regulatory Laws" },
        { type: "table", rows: [
          { label: "Licensing & CE", value: "24 hours / 2 years", description: "24 CE hours including 3 hours of Ethics biennially." },
          { label: "Unfair Trade Practices", value: "Rebating & Twisting prohibited", description: "Alaska Unfair Trade Practices Act." },
          { label: "Guaranty Association", value: "State Protection Fund", description: "Protects policyholders against insolvent insurers. Sales mention strictly illegal." }
        ]}
      ]
    },
    general_insurance_concepts: {
      title: "GENERAL INSURANCE CONCEPTS (ALASKA)",
      subtitle: "Contract mechanics · insurable interest · risk management",
      blocks: [
        { type: "heading", text: "Core Concepts" },
        { type: "table", rows: [
    ...
    life_insurance_products_and_provisions: {
      title: "AK LIFE PRODUCTS & PROVISIONS",
      subtitle: "Standard provisions · 10-day free look · nonforfeiture",
      blocks: [
        { type: "heading", text: "Standard Provisions" },
        { type: "table", rows: [
    ...
    annuities_and_federal_tax: {
      title: "ANNUITIES & FEDERAL TAX (ALASKA)",
      subtitle: "Annuity principles · NAIC Best Interest · MEC rules · 1035 exchange",
      blocks: [
        { type: "heading", text: "Annuity & Tax Principles" },
        { type: "table", rows: [
    ...
    master_numbers_drill: {
      title: "ALASKA MASTER NUMBERS DRILL",
      subtitle: "Key numbers and time periods for Alaska Life Producer exam",
      blocks: [
        { type: "heading", text: "Alaska Numbers" },
        { type: "table", rows: [
          { label: "Passing Score", value: "70%", description: "Minimum passing score." },
          { label: "CE Requirement", value: "24 hours / 2 years", description: "24 CE hours biennially." }
        ]}
  ...
  /* ══════════════════════════════════════════════════════════
     ARKANSAS LIFE PRODUCER
     ══════════════════════════════════════════════════════════ */
  ar_life_producer: {
    ar_insurance_regulation: {
      title: "ARKANSAS INSURANCE REGULATION",
      subtitle: "Arkansas Insurance Code · DOI authority · licensing & CE · Guaranty Association",
      blocks: [
        { type: "heading", text: "Arkansas Regulatory Laws" },
        { type: "table", rows: [
          { label: "Licensing & CE", value: "24 hours / 2 years", description: "24 CE hours including 3 hours of Ethics biennially." },
          { label: "Unfair Trade Practices", value: "Rebating & Twisting prohibited", description: "Arkansas Unfair Trade Practices Act." },
          { label: "Guaranty Association", value: "State Protection Fund", description: "Protects policyholders against insolvent insurers. Sales mention strictly illegal." }
        ]}
      ]
    },
    general_insurance_concepts: {
      title: "GENERAL INSURANCE CONCEPTS (ARKANSAS)",
      subtitle: "Contract mechanics · insurable interest · risk management",
      blocks: [
        { type: "heading", text: "Core Concepts" },
        { type: "table", rows: [
    ...
    life_insurance_products_and_provisions: {
      title: "AR LIFE PRODUCTS & PROVISIONS",
      subtitle: "Standard provisions · 10-day free look · nonforfeiture",
      blocks: [
        { type: "heading", text: "Standard Provisions" },
        { type: "table", rows: [
    ...
    annuities_and_federal_tax: {
      title: "ANNUITIES & FEDERAL TAX (ARKANSAS)",
      subtitle: "Annuity principles · NAIC Best Interest · MEC rules · 1035 exchange",
      blocks: [
        { type: "heading", text: "Annuity & Tax Principles" },
        { type: "table", rows: [
    ...
    master_numbers_drill: {
      title: "ARKANSAS MASTER NUMBERS DRILL",
      subtitle: "Key numbers and time periods for Arkansas Life Producer exam",
      blocks: [
        { type: "heading", text: "Arkansas Numbers" },
        { type: "table", rows: [
          { label: "Passing Score", value: "70%", description: "Minimum passing score." },
          { label: "CE Requirement", value: "24 hours / 2 years", description: "24 CE hours biennially." }
        ]}
  ...
  /* ══════════════════════════════════════════════════════════
     CONNECTICUT LIFE PRODUCER
     ══════════════════════════════════════════════════════════ */
  ct_life_producer: {
    ct_insurance_regulation: {
      title: "CONNECTICUT INSURANCE REGULATION",
      subtitle: "Connecticut Insurance Code · DOI authority · licensing & CE · Guaranty Association",
      blocks: [
        { type: "heading", text: "Connecticut Regulatory Laws" },
        { type: "table", rows: [
          { label: "Licensing & CE", value: "24 hours / 2 years", description: "24 CE hours including 3 hours of Ethics biennially." },
          { label: "Unfair Trade Practices", value: "Rebating & Twisting prohibited", description: "Connecticut Unfair Trade Practices Act." },
          { label: "Guaranty Association", value: "State Protection Fund", description: "Protects policyholders against insolvent insurers. Sales mention strictly illegal." }
        ]}
      ]
    },
    general_insurance_concepts: {
      title: "GENERAL INSURANCE CONCEPTS (CONNECTICUT)",
      subtitle: "Contract mechanics · insurable interest · risk management",
      blocks: [
        { type: "heading", text: "Core Concepts" },
        { type: "table", rows: [
    ...
    life_insurance_products_and_provisions: {
      title: "CT LIFE PRODUCTS & PROVISIONS",
      subtitle: "Standard provisions · 10-day free look · nonforfeiture",
      blocks: [
        { type: "heading", text: "Standard Provisions" },
        { type: "table", rows: [
    ...
    annuities_and_federal_tax: {
      title: "ANNUITIES & FEDERAL TAX (CONNECTICUT)",
      subtitle: "Annuity principles · NAIC Best Interest · MEC rules · 1035 exchange",
      blocks: [
        { type: "heading", text: "Annuity & Tax Principles" },
        { type: "table", rows: [
    ...
    master_numbers_drill: {
      title: "CONNECTICUT MASTER NUMBERS DRILL",
      subtitle: "Key numbers and time periods for Connecticut Life Producer exam",
      blocks: [
        { type: "heading", text: "Connecticut Numbers" },
        { type: "table", rows: [
          { label: "Passing Score", value: "70%", description: "Minimum passing score." },
          { label: "CE Requirement", value: "24 hours / 2 years", description: "24 CE hours biennially." }
        ]}
  ...
  /* ══════════════════════════════════════════════════════════
     DELAWARE LIFE PRODUCER
     ══════════════════════════════════════════════════════════ */
  de_life_producer: {
    de_insurance_regulation: {
      title: "DELAWARE INSURANCE REGULATION",
      subtitle: "Delaware Insurance Code · DOI authority · licensing & CE · Guaranty Association",
      blocks: [
        { type: "heading", text: "Delaware Regulatory Laws" },
        { type: "table", rows: [
          { label: "Licensing & CE", value: "24 hours / 2 years", description: "24 CE hours including 3 hours of Ethics biennially." },
          { label: "Unfair Trade Practices", value: "Rebating & Twisting prohibited", description: "Delaware Unfair Trade Practices Act." },
          { label: "Guaranty Association", value: "State Protection Fund", description: "Protects policyholders against insolvent insurers. Sales mention strictly illegal." }
        ]}
      ]
    },
    general_insurance_concepts: {
      title: "GENERAL INSURANCE CONCEPTS (DELAWARE)",
      subtitle: "Contract mechanics · insurable interest · risk management",
      blocks: [
        { type: "heading", text: "Core Concepts" },
        { type: "table", rows: [
    ...
    life_insurance_products_and_provisions: {
      title: "DE LIFE PRODUCTS & PROVISIONS",
      subtitle: "Standard provisions · 10-day free look · nonforfeiture",
      blocks: [
        { type: "heading", text: "Standard Provisions" },
        { type: "table", rows: [
    ...
    annuities_and_federal_tax: {
      title: "ANNUITIES & FEDERAL TAX (DELAWARE)",
      subtitle: "Annuity principles · NAIC Best Interest · MEC rules · 1035 exchange",
      blocks: [
        { type: "heading", text: "Annuity & Tax Principles" },
        { type: "table", rows: [
    ...
    master_numbers_drill: {
      title: "DELAWARE MASTER NUMBERS DRILL",
      subtitle: "Key numbers and time periods for Delaware Life Producer exam",
      blocks: [
        { type: "heading", text: "Delaware Numbers" },
        { type: "table", rows: [
          { label: "Passing Score", value: "70%", description: "Minimum passing score." },
          { label: "CE Requirement", value: "24 hours / 2 years", description: "24 CE hours biennially." }
        ]}
  ...
  /* ══════════════════════════════════════════════════════════
     DISTRICT OF COLUMBIA LIFE PRODUCER
     ══════════════════════════════════════════════════════════ */
  dc_life_producer: {
    dc_insurance_regulation: {
      title: "DISTRICT OF COLUMBIA INSURANCE REGULATION",
      subtitle: "District of Columbia Insurance Code · DOI authority · licensing & CE · Guaranty Association",
      blocks: [
        { type: "heading", text: "District of Columbia Regulatory Laws" },
        { type: "table", rows: [
          { label: "Licensing & CE", value: "24 hours / 2 years", description: "24 CE hours including 3 hours of Ethics biennially." },
          { label: "Unfair Trade Practices", value: "Rebating & Twisting prohibited", description: "District of Columbia Unfair Trade Practices Act." },
          { label: "Guaranty Association", value: "State Protection Fund", description: "Protects policyholders against insolvent insurers. Sales mention strictly illegal." }
        ]}
      ]
    },
    general_insurance_concepts: {
      title: "GENERAL INSURANCE CONCEPTS (DISTRICT OF COLUMBIA)",
      subtitle: "Contract mechanics · insurable interest · risk management",
      blocks: [
        { type: "heading", text: "Core Concepts" },
        { type: "table", rows: [
    ...
    life_insurance_products_and_provisions: {
      title: "DC LIFE PRODUCTS & PROVISIONS",
      subtitle: "Standard provisions · 10-day free look · nonforfeiture",
      blocks: [
        { type: "heading", text: "Standard Provisions" },
        { type: "table", rows: [
    ...
    annuities_and_federal_tax: {
      title: "ANNUITIES & FEDERAL TAX (DISTRICT OF COLUMBIA)",
      subtitle: "Annuity principles · NAIC Best Interest · MEC rules · 1035 exchange",
      blocks: [
        { type: "heading", text: "Annuity & Tax Principles" },
        { type: "table", rows: [
    ...
    master_numbers_drill: {
      title: "DISTRICT OF COLUMBIA MASTER NUMBERS DRILL",
      subtitle: "Key numbers and time periods for District of Columbia Life Producer exam",
      blocks: [
        { type: "heading", text: "District of Columbia Numbers" },
        { type: "table", rows: [
          { label: "Passing Score", value: "70%", description: "Minimum passing score." },
          { label: "CE Requirement", value: "24 hours / 2 years", description: "24 CE hours biennially." }
        ]}
  ...
  /* ══════════════════════════════════════════════════════════
     HAWAII LIFE PRODUCER
     ══════════════════════════════════════════════════════════ */
  hi_life_producer: {
    hi_insurance_regulation: {
      title: "HAWAII INSURANCE REGULATION",
      subtitle: "Hawaii Insurance Code · DOI authority · licensing & CE · Guaranty Association",
      blocks: [
        { type: "heading", text: "Hawaii Regulatory Laws" },
        { type: "table", rows: [
          { label: "Licensing & CE", value: "24 hours / 2 years", description: "24 CE hours including 3 hours of Ethics biennially." },
          { label: "Unfair Trade Practices", value: "Rebating & Twisting prohibited", description: "Hawaii Unfair Trade Practices Act." },
          { label: "Guaranty Association", value: "State Protection Fund", description: "Protects policyholders against insolvent insurers. Sales mention strictly illegal." }
        ]}
      ]
    },
    general_insurance_concepts: {
      title: "GENERAL INSURANCE CONCEPTS (HAWAII)",
      subtitle: "Contract mechanics · insurable interest · risk management",
      blocks: [
        { type: "heading", text: "Core Concepts" },
        { type: "table", rows: [
    ...
    life_insurance_products_and_provisions: {
      title: "HI LIFE PRODUCTS & PROVISIONS",
      subtitle: "Standard provisions · 10-day free look · nonforfeiture",
      blocks: [
        { type: "heading", text: "Standard Provisions" },
        { type: "table", rows: [
    ...
    annuities_and_federal_tax: {
      title: "ANNUITIES & FEDERAL TAX (HAWAII)",
      subtitle: "Annuity principles · NAIC Best Interest · MEC rules · 1035 exchange",
      blocks: [
        { type: "heading", text: "Annuity & Tax Principles" },
        { type: "table", rows: [
    ...
    master_numbers_drill: {
      title: "HAWAII MASTER NUMBERS DRILL",
      subtitle: "Key numbers and time periods for Hawaii Life Producer exam",
      blocks: [
        { type: "heading", text: "Hawaii Numbers" },
        { type: "table", rows: [
          { label: "Passing Score", value: "70%", description: "Minimum passing score." },
          { label: "CE Requirement", value: "24 hours / 2 years", description: "24 CE hours biennially." }
        ]}
  ...
  /* ══════════════════════════════════════════════════════════
     ...
     ══════════════════════════════════════════════════════════ */
  id_life_producer: {
    id_insurance_regulation: {
      title: "IDAHO INSURANCE REGULATION",
      subtitle: "Idaho Insurance Code · DOI authority · licensing & CE · Guaranty Association",
      blocks: [
        { type: "heading", text: "Idaho Regulatory Laws" },
        { type: "table", rows: [
          { label: "Licensing & CE", value: "24 hours / 2 years", description: "24 CE hours including 3 hours of Ethics biennially." },
          { label: "Unfair Trade Practices", value: "Rebating & Twisting prohibited", description: "Idaho Unfair Trade Practices Act." },
          { label: "Guaranty Association", value: "State Protection Fund", description: "Protects policyholders against insolvent insurers. Sales mention strictly illegal." }
        ]}
      ]
    },
    general_insurance_concepts: {
      title: "GENERAL INSURANCE CONCEPTS (IDAHO)",
      subtitle: "Contract mechanics · insurable interest · risk management",
      blocks: [
        { type: "heading", text: "Core Concepts" },
        { type: "table", rows: [
    ...
    life_insurance_products_and_provisions: {
      title: "ID LIFE PRODUCTS & PROVISIONS",
      subtitle: "Standard provisions · 10-day free look · nonforfeiture",
      blocks: [
        { type: "heading", text: "Standard Provisions" },
        { type: "table", rows: [
    ...
    annuities_and_federal_tax: {
      title: "ANNUITIES & FEDERAL TAX (IDAHO)",
      subtitle: "Annuity principles · NAIC Best Interest · MEC rules · 1035 exchange",
      blocks: [
        { type: "heading", text: "Annuity & Tax Principles" },
        { type: "table", rows: [
    ...
    master_numbers_drill: {
      title: "IDAHO MASTER NUMBERS DRILL",
      subtitle: "Key numbers and time periods for Idaho Life Producer exam",
      blocks: [
        { type: "heading", text: "Idaho Numbers" },
        { type: "table", rows: [
          { label: "Passing Score", value: "70%", description: "Minimum passing score." },
          { label: "CE Requirement", value: "24 hours / 2 years", description: "24 CE hours biennially." }
        ]}
  ...
  /* ══════════════════════════════════════════════════════════
     INDIANA LIFE PRODUCER
     ══════════════════════════════════════════════════════════ */
  in_life_producer: {
    in_insurance_regulation: {
      title: "INDIANA INSURANCE REGULATION",
      subtitle: "Indiana Insurance Code · DOI authority · licensing & CE · Guaranty Association",
      blocks: [
        { type: "heading", text: "Indiana Regulatory Laws" },
        { type: "table", rows: [
          { label: "Licensing & CE", value: "24 hours / 2 years", description: "24 CE hours including 3 hours of Ethics biennially." },
          { label: "Unfair Trade Practices", value: "Rebating & Twisting prohibited", description: "Indiana Unfair Trade Practices Act." },
          { label: "Guaranty Association", value: "State Protection Fund", description: "Protects policyholders against insolvent insurers. Sales mention strictly illegal." }
        ]}
      ]
    },
    general_insurance_concepts: {
      title: "GENERAL INSURANCE CONCEPTS (INDIANA)",
      subtitle: "Contract mechanics · insurable interest · risk management",
      blocks: [
        { type: "heading", text: "Core Concepts" },
        { type: "table", rows: [
    ...
    life_insurance_products_and_provisions: {
      title: "IN LIFE PRODUCTS & PROVISIONS",
      subtitle: "Standard provisions · 10-day free look · nonforfeiture",
      blocks: [
        { type: "heading", text: "Standard Provisions" },
        { type: "table", rows: [
    ...
    annuities_and_federal_tax: {
      title: "ANNUITIES & FEDERAL TAX (INDIANA)",
      subtitle: "Annuity principles · NAIC Best Interest · MEC rules · 1035 exchange",
      blocks: [
        { type: "heading", text: "Annuity & Tax Principles" },
        { type: "table", rows: [
    ...
    master_numbers_drill: {
      title: "INDIANA MASTER NUMBERS DRILL",
      subtitle: "Key numbers and time periods for Indiana Life Producer exam",
      blocks: [
        { type: "heading", text: "Indiana Numbers" },
        { type: "table", rows: [
          { label: "Passing Score", value: "70%", description: "Minimum passing score." },
          { label: "CE Requirement", value: "24 hours / 2 years", description: "24 CE hours biennially." }
        ]}
  ...
  /* ══════════════════════════════════════════════════════════
     ...
     ══════════════════════════════════════════════════════════ */
  ia_life_producer: {
    ia_insurance_regulation: {
      title: "IOWA INSURANCE REGULATION",
      subtitle: "Iowa Insurance Code · DOI authority · licensing & CE · Guaranty Association",
      blocks: [
        { type: "heading", text: "Iowa Regulatory Laws" },
        { type: "table", rows: [
          { label: "Licensing & CE", value: "24 hours / 2 years", description: "24 CE hours including 3 hours of Ethics biennially." },
          { label: "Unfair Trade Practices", value: "Rebating & Twisting prohibited", description: "Iowa Unfair Trade Practices Act." },
          { label: "Guaranty Association", value: "State Protection Fund", description: "Protects policyholders against insolvent insurers. Sales mention strictly illegal." }
        ]}
      ]
    },
    general_insurance_concepts: {
      title: "GENERAL INSURANCE CONCEPTS (IOWA)",
      subtitle: "Contract mechanics · insurable interest · risk management",
      blocks: [
        { type: "heading", text: "Core Concepts" },
        { type: "table", rows: [
    ...
    life_insurance_products_and_provisions: {
      title: "IA LIFE PRODUCTS & PROVISIONS",
      subtitle: "Standard provisions · 10-day free look · nonforfeiture",
      blocks: [
        { type: "heading", text: "Standard Provisions" },
        { type: "table", rows: [
    ...
    annuities_and_federal_tax: {
      title: "ANNUITIES & FEDERAL TAX (IOWA)",
      subtitle: "Annuity principles · NAIC Best Interest · MEC rules · 1035 exchange",
      blocks: [
        { type: "heading", text: "Annuity & Tax Principles" },
        { type: "table", rows: [
    ...
    master_numbers_drill: {
      title: "IOWA MASTER NUMBERS DRILL",
      subtitle: "Key numbers and time periods for Iowa Life Producer exam",
      blocks: [
        { type: "heading", text: "Iowa Numbers" },
        { type: "table", rows: [
          { label: "Passing Score", value: "70%", description: "Minimum passing score." },
          { label: "CE Requirement", value: "24 hours / 2 years", description: "24 CE hours biennially." }
        ]}
  ...
  /* ══════════════════════════════════════════════════════════
     KANSAS LIFE PRODUCER
     ══════════════════════════════════════════════════════════ */
  ks_life_producer: {
    ks_insurance_regulation: {
      title: "KANSAS INSURANCE REGULATION",
      subtitle: "Kansas Insurance Code · DOI authority · licensing & CE · Guaranty Association",
      blocks: [
        { type: "heading", text: "Kansas Regulatory Laws" },
        { type: "table", rows: [
          { label: "Licensing & CE", value: "24 hours / 2 years", description: "24 CE hours including 3 hours of Ethics biennially." },
          { label: "Unfair Trade Practices", value: "Rebating & Twisting prohibited", description: "Kansas Unfair Trade Practices Act." },
          { label: "Guaranty Association", value: "State Protection Fund", description: "Protects policyholders against insolvent insurers. Sales mention strictly illegal." }
        ]}
      ]
    },
    general_insurance_concepts: {
      title: "GENERAL INSURANCE CONCEPTS (KANSAS)",
      subtitle: "Contract mechanics · insurable interest · risk management",
      blocks: [
        { type: "heading", text: "Core Concepts" },
        { type: "table", rows: [
    ...
    life_insurance_products_and_provisions: {
      title: "KS LIFE PRODUCTS & PROVISIONS",
      subtitle: "Standard provisions · 10-day free look · nonforfeiture",
      blocks: [
        { type: "heading", text: "Standard Provisions" },
        { type: "table", rows: [
    ...
    annuities_and_federal_tax: {
      title: "ANNUITIES & FEDERAL TAX (KANSAS)",
      subtitle: "Annuity principles · NAIC Best Interest · MEC rules · 1035 exchange",
      blocks: [
        { type: "heading", text: "Annuity & Tax Principles" },
        { type: "table", rows: [
    ...
    master_numbers_drill: {
      title: "KANSAS MASTER NUMBERS DRILL",
      subtitle: "Key numbers and time periods for Kansas Life Producer exam",
      blocks: [
        { type: "heading", text: "Kansas Numbers" },
        { type: "table", rows: [
          { label: "Passing Score", value: "70%", description: "Minimum passing score." },
          { label: "CE Requirement", value: "24 hours / 2 years", description: "24 CE hours biennially." }
        ]}
  ...
  /* ══════════════════════════════════════════════════════════
     KENTUCKY LIFE PRODUCER
     ══════════════════════════════════════════════════════════ */
  ky_life_producer: {
    ky_insurance_regulation: {
      title: "KENTUCKY INSURANCE REGULATION",
      subtitle: "Kentucky Insurance Code · DOI authority · licensing & CE · Guaranty Association",
      blocks: [
        { type: "heading", text: "Kentucky Regulatory Laws" },
        { type: "table", rows: [
          { label: "Licensing & CE", value: "24 hours / 2 years", description: "24 CE hours including 3 hours of Ethics biennially." },
          { label: "Unfair Trade Practices", value: "Rebating & Twisting prohibited", description: "Kentucky Unfair Trade Practices Act." },
          { label: "Guaranty Association", value: "State Protection Fund", description: "Protects policyholders against insolvent insurers. Sales mention strictly illegal." }
        ]}
      ]
    },
    general_insurance_concepts: {
      title: "GENERAL INSURANCE CONCEPTS (KENTUCKY)",
      subtitle: "Contract mechanics · insurable interest · risk management",
      blocks: [
        { type: "heading", text: "Core Concepts" },
        { type: "table", rows: [
    ...
    life_insurance_products_and_provisions: {
      title: "KY LIFE PRODUCTS & PROVISIONS",
      subtitle: "Standard provisions · 10-day free look · nonforfeiture",
      blocks: [
        { type: "heading", text: "Standard Provisions" },
        { type: "table", rows: [
    ...
    annuities_and_federal_tax: {
      title: "ANNUITIES & FEDERAL TAX (KENTUCKY)",
      subtitle: "Annuity principles · NAIC Best Interest · MEC rules · 1035 exchange",
      blocks: [
        { type: "heading", text: "Annuity & Tax Principles" },
        { type: "table", rows: [
    ...
    master_numbers_drill: {
      title: "KENTUCKY MASTER NUMBERS DRILL",
      subtitle: "Key numbers and time periods for Kentucky Life Producer exam",
      blocks: [
        { type: "heading", text: "Kentucky Numbers" },
        { type: "table", rows: [
          { label: "Passing Score", value: "70%", description: "Minimum passing score." },
          { label: "CE Requirement", value: "24 hours / 2 years", description: "24 CE hours biennially." }
        ]}
  ...
  /* ══════════════════════════════════════════════════════════
     LOUISIANA LIFE PRODUCER
     ══════════════════════════════════════════════════════════ */
  la_life_producer: {
    la_insurance_regulation: {
      title: "LOUISIANA INSURANCE REGULATION",
      subtitle: "Louisiana Insurance Code · DOI authority · licensing & CE · Guaranty Association",
      blocks: [
        { type: "heading", text: "Louisiana Regulatory Laws" },
        { type: "table", rows: [
          { label: "Licensing & CE", value: "24 hours / 2 years", description: "24 CE hours including 3 hours of Ethics biennially." },
          { label: "Unfair Trade Practices", value: "Rebating & Twisting prohibited", description: "Louisiana Unfair Trade Practices Act." },
          { label: "Guaranty Association", value: "State Protection Fund", description: "Protects policyholders against insolvent insurers. Sales mention strictly illegal." }
        ]}
      ]
    },
    general_insurance_concepts: {
      title: "GENERAL INSURANCE CONCEPTS (LOUISIANA)",
      subtitle: "Contract mechanics · insurable interest · risk management",
      blocks: [
        { type: "heading", text: "Core Concepts" },
        { type: "table", rows: [
    ...
    life_insurance_products_and_provisions: {
      title: "LA LIFE PRODUCTS & PROVISIONS",
      subtitle: "Standard provisions · 10-day free look · nonforfeiture",
      blocks: [
        { type: "heading", text: "Standard Provisions" },
        { type: "table", rows: [
    ...
    annuities_and_federal_tax: {
      title: "ANNUITIES & FEDERAL TAX (LOUISIANA)",
      subtitle: "Annuity principles · NAIC Best Interest · MEC rules · 1035 exchange",
      blocks: [
        { type: "heading", text: "Annuity & Tax Principles" },
        { type: "table", rows: [
    ...
    master_numbers_drill: {
      title: "LOUISIANA MASTER NUMBERS DRILL",
      subtitle: "Key numbers and time periods for Louisiana Life Producer exam",
      blocks: [
        { type: "heading", text: "Louisiana Numbers" },
        { type: "table", rows: [
          { label: "Passing Score", value: "70%", description: "Minimum passing score." },
          { label: "CE Requirement", value: "24 hours / 2 years", description: "24 CE hours biennially." }
        ]}
  ...
  /* ══════════════════════════════════════════════════════════
     ...
     ══════════════════════════════════════════════════════════ */
  me_life_producer: {
    me_insurance_regulation: {
      title: "MAINE INSURANCE REGULATION",
      subtitle: "Maine Insurance Code · DOI authority · licensing & CE · Guaranty Association",
      blocks: [
        { type: "heading", text: "Maine Regulatory Laws" },
        { type: "table", rows: [
          { label: "Licensing & CE", value: "24 hours / 2 years", description: "24 CE hours including 3 hours of Ethics biennially." },
          { label: "Unfair Trade Practices", value: "Rebating & Twisting prohibited", description: "Maine Unfair Trade Practices Act." },
          { label: "Guaranty Association", value: "State Protection Fund", description: "Protects policyholders against insolvent insurers. Sales mention strictly illegal." }
        ]}
      ]
    },
    general_insurance_concepts: {
      title: "GENERAL INSURANCE CONCEPTS (MAINE)",
      subtitle: "Contract mechanics · insurable interest · risk management",
      blocks: [
        { type: "heading", text: "Core Concepts" },
        { type: "table", rows: [
    ...
    life_insurance_products_and_provisions: {
      title: "ME LIFE PRODUCTS & PROVISIONS",
      subtitle: "Standard provisions · 10-day free look · nonforfeiture",
      blocks: [
        { type: "heading", text: "Standard Provisions" },
        { type: "table", rows: [
    ...
    annuities_and_federal_tax: {
      title: "ANNUITIES & FEDERAL TAX (MAINE)",
      subtitle: "Annuity principles · NAIC Best Interest · MEC rules · 1035 exchange",
      blocks: [
        { type: "heading", text: "Annuity & Tax Principles" },
        { type: "table", rows: [
    ...
    master_numbers_drill: {
      title: "MAINE MASTER NUMBERS DRILL",
      subtitle: "Key numbers and time periods for Maine Life Producer exam",
      blocks: [
        { type: "heading", text: "Maine Numbers" },
        { type: "table", rows: [
          { label: "Passing Score", value: "70%", description: "Minimum passing score." },
          { label: "CE Requirement", value: "24 hours / 2 years", description: "24 CE hours biennially." }
        ]}
  ...
  /* ══════════════════════════════════════════════════════════
     MISSISSIPPI LIFE PRODUCER
     ══════════════════════════════════════════════════════════ */
  ms_life_producer: {
    ms_insurance_regulation: {
      title: "MISSISSIPPI INSURANCE REGULATION",
      subtitle: "Mississippi Insurance Code · DOI authority · licensing & CE · Guaranty Association",
      blocks: [
        { type: "heading", text: "Mississippi Regulatory Laws" },
        { type: "table", rows: [
          { label: "Licensing & CE", value: "24 hours / 2 years", description: "24 CE hours including 3 hours of Ethics biennially." },
          { label: "Unfair Trade Practices", value: "Rebating & Twisting prohibited", description: "Mississippi Unfair Trade Practices Act." },
          { label: "Guaranty Association", value: "State Protection Fund", description: "Protects policyholders against insolvent insurers. Sales mention strictly illegal." }
        ]}
      ]
    },
    general_insurance_concepts: {
      title: "GENERAL INSURANCE CONCEPTS (MISSISSIPPI)",
      subtitle: "Contract mechanics · insurable interest · risk management",
      blocks: [
        { type: "heading", text: "Core Concepts" },
        { type: "table", rows: [
    ...
    life_insurance_products_and_provisions: {
      title: "MS LIFE PRODUCTS & PROVISIONS",
      subtitle: "Standard provisions · 10-day free look · nonforfeiture",
      blocks: [
        { type: "heading", text: "Standard Provisions" },
        { type: "table", rows: [
    ...
    annuities_and_federal_tax: {
      title: "ANNUITIES & FEDERAL TAX (MISSISSIPPI)",
      subtitle: "Annuity principles · NAIC Best Interest · MEC rules · 1035 exchange",
      blocks: [
        { type: "heading", text: "Annuity & Tax Principles" },
        { type: "table", rows: [
    ...
    master_numbers_drill: {
      title: "MISSISSIPPI MASTER NUMBERS DRILL",
      subtitle: "Key numbers and time periods for Mississippi Life Producer exam",
      blocks: [
        { type: "heading", text: "Mississippi Numbers" },
        { type: "table", rows: [
          { label: "Passing Score", value: "70%", description: "Minimum passing score." },
          { label: "CE Requirement", value: "24 hours / 2 years", description: "24 CE hours biennially." }
        ]}
  ...
  /* ══════════════════════════════════════════════════════════
     MONTANA LIFE PRODUCER
     ══════════════════════════════════════════════════════════ */
  mt_life_producer: {
    mt_insurance_regulation: {
      title: "MONTANA INSURANCE REGULATION",
      subtitle: "Montana Insurance Code · DOI authority · licensing & CE · Guaranty Association",
      blocks: [
        { type: "heading", text: "Montana Regulatory Laws" },
        { type: "table", rows: [
          { label: "Licensing & CE", value: "24 hours / 2 years", description: "24 CE hours including 3 hours of Ethics biennially." },
          { label: "Unfair Trade Practices", value: "Rebating & Twisting prohibited", description: "Montana Unfair Trade Practices Act." },
          { label: "Guaranty Association", value: "State Protection Fund", description: "Protects policyholders against insolvent insurers. Sales mention strictly illegal." }
        ]}
      ]
    },
    general_insurance_concepts: {
      title: "GENERAL INSURANCE CONCEPTS (MONTANA)",
      subtitle: "Contract mechanics · insurable interest · risk management",
      blocks: [
        { type: "heading", text: "Core Concepts" },
        { type: "table", rows: [
    ...
    life_insurance_products_and_provisions: {
      title: "MT LIFE PRODUCTS & PROVISIONS",
      subtitle: "Standard provisions · 10-day free look · nonforfeiture",
      blocks: [
        { type: "heading", text: "Standard Provisions" },
        { type: "table", rows: [
    ...
    annuities_and_federal_tax: {
      title: "ANNUITIES & FEDERAL TAX (MONTANA)",
      subtitle: "Annuity principles · NAIC Best Interest · MEC rules · 1035 exchange",
      blocks: [
        { type: "heading", text: "Annuity & Tax Principles" },
        { type: "table", rows: [
    ...
    master_numbers_drill: {
      title: "MONTANA MASTER NUMBERS DRILL",
      subtitle: "Key numbers and time periods for Montana Life Producer exam",
      blocks: [
        { type: "heading", text: "Montana Numbers" },
        { type: "table", rows: [
          { label: "Passing Score", value: "70%", description: "Minimum passing score." },
          { label: "CE Requirement", value: "24 hours / 2 years", description: "24 CE hours biennially." }
        ]}
  ...
  /* ══════════════════════════════════════════════════════════
     NEBRASKA LIFE PRODUCER
     ══════════════════════════════════════════════════════════ */
  ne_life_producer: {
    ne_insurance_regulation: {
      title: "NEBRASKA INSURANCE REGULATION",
      subtitle: "Nebraska Insurance Code · DOI authority · licensing & CE · Guaranty Association",
      blocks: [
        { type: "heading", text: "Nebraska Regulatory Laws" },
        { type: "table", rows: [
          { label: "Licensing & CE", value: "24 hours / 2 years", description: "24 CE hours including 3 hours of Ethics biennially." },
          { label: "Unfair Trade Practices", value: "Rebating & Twisting prohibited", description: "Nebraska Unfair Trade Practices Act." },
          { label: "Guaranty Association", value: "State Protection Fund", description: "Protects policyholders against insolvent insurers. Sales mention strictly illegal." }
        ]}
      ]
    },
    general_insurance_concepts: {
      title: "GENERAL INSURANCE CONCEPTS (NEBRASKA)",
      subtitle: "Contract mechanics · insurable interest · risk management",
      blocks: [
        { type: "heading", text: "Core Concepts" },
        { type: "table", rows: [
    ...
    life_insurance_products_and_provisions: {
      title: "NE LIFE PRODUCTS & PROVISIONS",
      subtitle: "Standard provisions · 10-day free look · nonforfeiture",
      blocks: [
        { type: "heading", text: "Standard Provisions" },
        { type: "table", rows: [
    ...
    annuities_and_federal_tax: {
      title: "ANNUITIES & FEDERAL TAX (NEBRASKA)",
      subtitle: "Annuity principles · NAIC Best Interest · MEC rules · 1035 exchange",
      blocks: [
        { type: "heading", text: "Annuity & Tax Principles" },
        { type: "table", rows: [
    ...
    master_numbers_drill: {
      title: "NEBRASKA MASTER NUMBERS DRILL",
      subtitle: "Key numbers and time periods for Nebraska Life Producer exam",
      blocks: [
        { type: "heading", text: "Nebraska Numbers" },
        { type: "table", rows: [
          { label: "Passing Score", value: "70%", description: "Minimum passing score." },
          { label: "CE Requirement", value: "24 hours / 2 years", description: "24 CE hours biennially." }
        ]}
  ...
  /* ══════════════════════════════════════════════════════════
     NEVADA LIFE PRODUCER
     ══════════════════════════════════════════════════════════ */
  nv_life_producer: {
    nv_insurance_regulation: {
      title: "NEVADA INSURANCE REGULATION",
      subtitle: "Nevada Insurance Code · DOI authority · licensing & CE · Guaranty Association",
      blocks: [
        { type: "heading", text: "Nevada Regulatory Laws" },
        { type: "table", rows: [
          { label: "Licensing & CE", value: "24 hours / 2 years", description: "24 CE hours including 3 hours of Ethics biennially." },
          { label: "Unfair Trade Practices", value: "Rebating & Twisting prohibited", description: "Nevada Unfair Trade Practices Act." },
          { label: "Guaranty Association", value: "State Protection Fund", description: "Protects policyholders against insolvent insurers. Sales mention strictly illegal." }
        ]}
      ]
    },
    general_insurance_concepts: {
      title: "GENERAL INSURANCE CONCEPTS (NEVADA)",
      subtitle: "Contract mechanics · insurable interest · risk management",
      blocks: [
        { type: "heading", text: "Core Concepts" },
        { type: "table", rows: [
    ...
    life_insurance_products_and_provisions: {
      title: "NV LIFE PRODUCTS & PROVISIONS",
      subtitle: "Standard provisions · 10-day free look · nonforfeiture",
      blocks: [
        { type: "heading", text: "Standard Provisions" },
        { type: "table", rows: [
    ...
    annuities_and_federal_tax: {
      title: "ANNUITIES & FEDERAL TAX (NEVADA)",
      subtitle: "Annuity principles · NAIC Best Interest · MEC rules · 1035 exchange",
      blocks: [
        { type: "heading", text: "Annuity & Tax Principles" },
        { type: "table", rows: [
    ...
    master_numbers_drill: {
      title: "NEVADA MASTER NUMBERS DRILL",
      subtitle: "Key numbers and time periods for Nevada Life Producer exam",
      blocks: [
        { type: "heading", text: "Nevada Numbers" },
        { type: "table", rows: [
          { label: "Passing Score", value: "70%", description: "Minimum passing score." },
          { label: "CE Requirement", value: "24 hours / 2 years", description: "24 CE hours biennially." }
        ]}
  ...
  /* ══════════════════════════════════════════════════════════
     NEW HAMPSHIRE LIFE PRODUCER
     ══════════════════════════════════════════════════════════ */
  nh_life_producer: {
    nh_insurance_regulation: {
      title: "NEW HAMPSHIRE INSURANCE REGULATION",
      subtitle: "New Hampshire Insurance Code · DOI authority · licensing & CE · Guaranty Association",
      blocks: [
        { type: "heading", text: "New Hampshire Regulatory Laws" },
        { type: "table", rows: [
          { label: "Licensing & CE", value: "24 hours / 2 years", description: "24 CE hours including 3 hours of Ethics biennially." },
          { label: "Unfair Trade Practices", value: "Rebating & Twisting prohibited", description: "New Hampshire Unfair Trade Practices Act." },
          { label: "Guaranty Association", value: "State Protection Fund", description: "Protects policyholders against insolvent insurers. Sales mention strictly illegal." }
        ]}
      ]
    },
    general_insurance_concepts: {
      title: "GENERAL INSURANCE CONCEPTS (NEW HAMPSHIRE)",
      subtitle: "Contract mechanics · insurable interest · risk management",
      blocks: [
        { type: "heading", text: "Core Concepts" },
        { type: "table", rows: [
    ...
    life_insurance_products_and_provisions: {
      title: "NH LIFE PRODUCTS & PROVISIONS",
      subtitle: "Standard provisions · 10-day free look · nonforfeiture",
      blocks: [
        { type: "heading", text: "Standard Provisions" },
        { type: "table", rows: [
    ...
    annuities_and_federal_tax: {
      title: "ANNUITIES & FEDERAL TAX (NEW HAMPSHIRE)",
      subtitle: "Annuity principles · NAIC Best Interest · MEC rules · 1035 exchange",
      blocks: [
        { type: "heading", text: "Annuity & Tax Principles" },
        { type: "table", rows: [
    ...
    master_numbers_drill: {
      title: "NEW HAMPSHIRE MASTER NUMBERS DRILL",
      subtitle: "Key numbers and time periods for New Hampshire Life Producer exam",
      blocks: [
        { type: "heading", text: "New Hampshire Numbers" },
        { type: "table", rows: [
          { label: "Passing Score", value: "70%", description: "Minimum passing score." },
          { label: "CE Requirement", value: "24 hours / 2 years", description: "24 CE hours biennially." }
        ]}
  ...
  /* ══════════════════════════════════════════════════════════
     NEW MEXICO LIFE PRODUCER
     ══════════════════════════════════════════════════════════ */
  nm_life_producer: {
    nm_insurance_regulation: {
      title: "NEW MEXICO INSURANCE REGULATION",
      subtitle: "New Mexico Insurance Code · DOI authority · licensing & CE · Guaranty Association",
      blocks: [
        { type: "heading", text: "New Mexico Regulatory Laws" },
        { type: "table", rows: [
          { label: "Licensing & CE", value: "24 hours / 2 years", description: "24 CE hours including 3 hours of Ethics biennially." },
          { label: "Unfair Trade Practices", value: "Rebating & Twisting prohibited", description: "New Mexico Unfair Trade Practices Act." },
          { label: "Guaranty Association", value: "State Protection Fund", description: "Protects policyholders against insolvent insurers. Sales mention strictly illegal." }
        ]}
      ]
    },
    general_insurance_concepts: {
      title: "GENERAL INSURANCE CONCEPTS (NEW MEXICO)",
      subtitle: "Contract mechanics · insurable interest · risk management",
      blocks: [
        { type: "heading", text: "Core Concepts" },
        { type: "table", rows: [
    ...
    life_insurance_products_and_provisions: {
      title: "NM LIFE PRODUCTS & PROVISIONS",
      subtitle: "Standard provisions · 10-day free look · nonforfeiture",
      blocks: [
        { type: "heading", text: "Standard Provisions" },
        { type: "table", rows: [
    ...
    annuities_and_federal_tax: {
      title: "ANNUITIES & FEDERAL TAX (NEW MEXICO)",
      subtitle: "Annuity principles · NAIC Best Interest · MEC rules · 1035 exchange",
      blocks: [
        { type: "heading", text: "Annuity & Tax Principles" },
        { type: "table", rows: [
    ...
    master_numbers_drill: {
      title: "NEW MEXICO MASTER NUMBERS DRILL",
      subtitle: "Key numbers and time periods for New Mexico Life Producer exam",
      blocks: [
        { type: "heading", text: "New Mexico Numbers" },
        { type: "table", rows: [
          { label: "Passing Score", value: "70%", description: "Minimum passing score." },
          { label: "CE Requirement", value: "24 hours / 2 years", description: "24 CE hours biennially." }
        ]}
  ...
  /* ══════════════════════════════════════════════════════════
     NORTH DAKOTA LIFE PRODUCER
     ══════════════════════════════════════════════════════════ */
  nd_life_producer: {
    nd_insurance_regulation: {
      title: "NORTH DAKOTA INSURANCE REGULATION",
      subtitle: "North Dakota Insurance Code · DOI authority · licensing & CE · Guaranty Association",
      blocks: [
        { type: "heading", text: "North Dakota Regulatory Laws" },
        { type: "table", rows: [
          { label: "Licensing & CE", value: "24 hours / 2 years", description: "24 CE hours including 3 hours of Ethics biennially." },
          { label: "Unfair Trade Practices", value: "Rebating & Twisting prohibited", description: "North Dakota Unfair Trade Practices Act." },
          { label: "Guaranty Association", value: "State Protection Fund", description: "Protects policyholders against insolvent insurers. Sales mention strictly illegal." }
        ]}
      ]
    },
    general_insurance_concepts: {
      title: "GENERAL INSURANCE CONCEPTS (NORTH DAKOTA)",
      subtitle: "Contract mechanics · insurable interest · risk management",
      blocks: [
        { type: "heading", text: "Core Concepts" },
        { type: "table", rows: [
    ...
    life_insurance_products_and_provisions: {
      title: "ND LIFE PRODUCTS & PROVISIONS",
      subtitle: "Standard provisions · 10-day free look · nonforfeiture",
      blocks: [
        { type: "heading", text: "Standard Provisions" },
        { type: "table", rows: [
    ...
    annuities_and_federal_tax: {
      title: "ANNUITIES & FEDERAL TAX (NORTH DAKOTA)",
      subtitle: "Annuity principles · NAIC Best Interest · MEC rules · 1035 exchange",
      blocks: [
        { type: "heading", text: "Annuity & Tax Principles" },
        { type: "table", rows: [
    ...
    master_numbers_drill: {
      title: "NORTH DAKOTA MASTER NUMBERS DRILL",
      subtitle: "Key numbers and time periods for North Dakota Life Producer exam",
      blocks: [
        { type: "heading", text: "North Dakota Numbers" },
        { type: "table", rows: [
          { label: "Passing Score", value: "70%", description: "Minimum passing score." },
          { label: "CE Requirement", value: "24 hours / 2 years", description: "24 CE hours biennially." }
        ]}
  ...
  /* ══════════════════════════════════════════════════════════
     OKLAHOMA LIFE PRODUCER
     ══════════════════════════════════════════════════════════ */
  ok_life_producer: {
    ok_insurance_regulation: {
      title: "OKLAHOMA INSURANCE REGULATION",
      subtitle: "Oklahoma Insurance Code · DOI authority · licensing & CE · Guaranty Association",
      blocks: [
        { type: "heading", text: "Oklahoma Regulatory Laws" },
        { type: "table", rows: [
          { label: "Licensing & CE", value: "24 hours / 2 years", description: "24 CE hours including 3 hours of Ethics biennially." },
          { label: "Unfair Trade Practices", value: "Rebating & Twisting prohibited", description: "Oklahoma Unfair Trade Practices Act." },
          { label: "Guaranty Association", value: "State Protection Fund", description: "Protects policyholders against insolvent insurers. Sales mention strictly illegal." }
        ]}
      ]
    },
    general_insurance_concepts: {
      title: "GENERAL INSURANCE CONCEPTS (OKLAHOMA)",
      subtitle: "Contract mechanics · insurable interest · risk management",
      blocks: [
        { type: "heading", text: "Core Concepts" },
        { type: "table", rows: [
    ...
    life_insurance_products_and_provisions: {
      title: "OK LIFE PRODUCTS & PROVISIONS",
      subtitle: "Standard provisions · 10-day free look · nonforfeiture",
      blocks: [
        { type: "heading", text: "Standard Provisions" },
        { type: "table", rows: [
    ...
    annuities_and_federal_tax: {
      title: "ANNUITIES & FEDERAL TAX (OKLAHOMA)",
      subtitle: "Annuity principles · NAIC Best Interest · MEC rules · 1035 exchange",
      blocks: [
        { type: "heading", text: "Annuity & Tax Principles" },
        { type: "table", rows: [
    ...
    master_numbers_drill: {
      title: "OKLAHOMA MASTER NUMBERS DRILL",
      subtitle: "Key numbers and time periods for Oklahoma Life Producer exam",
      blocks: [
        { type: "heading", text: "Oklahoma Numbers" },
        { type: "table", rows: [
          { label: "Passing Score", value: "70%", description: "Minimum passing score." },
          { label: "CE Requirement", value: "24 hours / 2 years", description: "24 CE hours biennially." }
        ]}
  ...
  /* ══════════════════════════════════════════════════════════
     OREGON LIFE PRODUCER
     ══════════════════════════════════════════════════════════ */
  or_life_producer: {
    or_insurance_regulation: {
      title: "OREGON INSURANCE REGULATION",
      subtitle: "Oregon Insurance Code · DOI authority · licensing & CE · Guaranty Association",
      blocks: [
        { type: "heading", text: "Oregon Regulatory Laws" },
        { type: "table", rows: [
          { label: "Licensing & CE", value: "24 hours / 2 years", description: "24 CE hours including 3 hours of Ethics biennially." },
          { label: "Unfair Trade Practices", value: "Rebating & Twisting prohibited", description: "Oregon Unfair Trade Practices Act." },
          { label: "Guaranty Association", value: "State Protection Fund", description: "Protects policyholders against insolvent insurers. Sales mention strictly illegal." }
        ]}
      ]
    },
    general_insurance_concepts: {
      title: "GENERAL INSURANCE CONCEPTS (OREGON)",
      subtitle: "Contract mechanics · insurable interest · risk management",
      blocks: [
        { type: "heading", text: "Core Concepts" },
        { type: "table", rows: [
    ...
    life_insurance_products_and_provisions: {
      title: "OR LIFE PRODUCTS & PROVISIONS",
      subtitle: "Standard provisions · 10-day free look · nonforfeiture",
      blocks: [
        { type: "heading", text: "Standard Provisions" },
        { type: "table", rows: [
    ...
    annuities_and_federal_tax: {
      title: "ANNUITIES & FEDERAL TAX (OREGON)",
      subtitle: "Annuity principles · NAIC Best Interest · MEC rules · 1035 exchange",
      blocks: [
        { type: "heading", text: "Annuity & Tax Principles" },
        { type: "table", rows: [
    ...
    master_numbers_drill: {
      title: "OREGON MASTER NUMBERS DRILL",
      subtitle: "Key numbers and time periods for Oregon Life Producer exam",
      blocks: [
        { type: "heading", text: "Oregon Numbers" },
        { type: "table", rows: [
          { label: "Passing Score", value: "70%", description: "Minimum passing score." },
          { label: "CE Requirement", value: "24 hours / 2 years", description: "24 CE hours biennially." }
        ]}
  ...
  /* ══════════════════════════════════════════════════════════
     ...
     ══════════════════════════════════════════════════════════ */
  ri_life_producer: {
    ri_insurance_regulation: {
      title: "RHODE ISLAND INSURANCE REGULATION",
      subtitle: "Rhode Island Insurance Code · DOI authority · licensing & CE · Guaranty Association",
      blocks: [
        { type: "heading", text: "Rhode Island Regulatory Laws" },
        { type: "table", rows: [
          { label: "Licensing & CE", value: "24 hours / 2 years", description: "24 CE hours including 3 hours of Ethics biennially." },
          { label: "Unfair Trade Practices", value: "Rebating & Twisting prohibited", description: "Rhode Island Unfair Trade Practices Act." },
          { label: "Guaranty Association", value: "State Protection Fund", description: "Protects policyholders against insolvent insurers. Sales mention strictly illegal." }
        ]}
      ]
    },
    general_insurance_concepts: {
      title: "GENERAL INSURANCE CONCEPTS (RHODE ISLAND)",
      subtitle: "Contract mechanics · insurable interest · risk management",
      blocks: [
        { type: "heading", text: "Core Concepts" },
        { type: "table", rows: [
    ...
    life_insurance_products_and_provisions: {
      title: "RI LIFE PRODUCTS & PROVISIONS",
      subtitle: "Standard provisions · 10-day free look · nonforfeiture",
      blocks: [
        { type: "heading", text: "Standard Provisions" },
        { type: "table", rows: [
    ...
    annuities_and_federal_tax: {
      title: "ANNUITIES & FEDERAL TAX (RHODE ISLAND)",
      subtitle: "Annuity principles · NAIC Best Interest · MEC rules · 1035 exchange",
      blocks: [
        { type: "heading", text: "Annuity & Tax Principles" },
        { type: "table", rows: [
    ...
    master_numbers_drill: {
      title: "RHODE ISLAND MASTER NUMBERS DRILL",
      subtitle: "Key numbers and time periods for Rhode Island Life Producer exam",
      blocks: [
        { type: "heading", text: "Rhode Island Numbers" },
        { type: "table", rows: [
          { label: "Passing Score", value: "70%", description: "Minimum passing score." },
          { label: "CE Requirement", value: "24 hours / 2 years", description: "24 CE hours biennially." }
        ]}
  ...
  /* ══════════════════════════════════════════════════════════
     SOUTH CAROLINA LIFE PRODUCER
     ══════════════════════════════════════════════════════════ */
  sc_life_producer: {
    sc_insurance_regulation: {
      title: "SOUTH CAROLINA INSURANCE REGULATION",
      subtitle: "South Carolina Insurance Code · DOI authority · licensing & CE · Guaranty Association",
      blocks: [
        { type: "heading", text: "South Carolina Regulatory Laws" },
        { type: "table", rows: [
          { label: "Licensing & CE", value: "24 hours / 2 years", description: "24 CE hours including 3 hours of Ethics biennially." },
          { label: "Unfair Trade Practices", value: "Rebating & Twisting prohibited", description: "South Carolina Unfair Trade Practices Act." },
          { label: "Guaranty Association", value: "State Protection Fund", description: "Protects policyholders against insolvent insurers. Sales mention strictly illegal." }
        ]}
      ]
    },
    general_insurance_concepts: {
      title: "GENERAL INSURANCE CONCEPTS (SOUTH CAROLINA)",
      subtitle: "Contract mechanics · insurable interest · risk management",
      blocks: [
        { type: "heading", text: "Core Concepts" },
        { type: "table", rows: [
    ...
    life_insurance_products_and_provisions: {
      title: "SC LIFE PRODUCTS & PROVISIONS",
      subtitle: "Standard provisions · 10-day free look · nonforfeiture",
      blocks: [
        { type: "heading", text: "Standard Provisions" },
        { type: "table", rows: [
    ...
    annuities_and_federal_tax: {
      title: "ANNUITIES & FEDERAL TAX (SOUTH CAROLINA)",
      subtitle: "Annuity principles · NAIC Best Interest · MEC rules · 1035 exchange",
      blocks: [
        { type: "heading", text: "Annuity & Tax Principles" },
        { type: "table", rows: [
    ...
    master_numbers_drill: {
      title: "SOUTH CAROLINA MASTER NUMBERS DRILL",
      subtitle: "Key numbers and time periods for South Carolina Life Producer exam",
      blocks: [
        { type: "heading", text: "South Carolina Numbers" },
        { type: "table", rows: [
          { label: "Passing Score", value: "70%", description: "Minimum passing score." },
          { label: "CE Requirement", value: "24 hours / 2 years", description: "24 CE hours biennially." }
        ]}
  ...
  /* ══════════════════════════════════════════════════════════
     SOUTH DAKOTA LIFE PRODUCER
     ══════════════════════════════════════════════════════════ */
  sd_life_producer: {
    sd_insurance_regulation: {
      title: "SOUTH DAKOTA INSURANCE REGULATION",
      subtitle: "South Dakota Insurance Code · DOI authority · licensing & CE · Guaranty Association",
      blocks: [
        { type: "heading", text: "South Dakota Regulatory Laws" },
        { type: "table", rows: [
          { label: "Licensing & CE", value: "24 hours / 2 years", description: "24 CE hours including 3 hours of Ethics biennially." },
          { label: "Unfair Trade Practices", value: "Rebating & Twisting prohibited", description: "South Dakota Unfair Trade Practices Act." },
          { label: "Guaranty Association", value: "State Protection Fund", description: "Protects policyholders against insolvent insurers. Sales mention strictly illegal." }
        ]}
      ]
    },
    general_insurance_concepts: {
      title: "GENERAL INSURANCE CONCEPTS (SOUTH DAKOTA)",
      subtitle: "Contract mechanics · insurable interest · risk management",
      blocks: [
        { type: "heading", text: "Core Concepts" },
        { type: "table", rows: [
    ...
    life_insurance_products_and_provisions: {
      title: "SD LIFE PRODUCTS & PROVISIONS",
      subtitle: "Standard provisions · 10-day free look · nonforfeiture",
      blocks: [
        { type: "heading", text: "Standard Provisions" },
        { type: "table", rows: [
    ...
    annuities_and_federal_tax: {
      title: "ANNUITIES & FEDERAL TAX (SOUTH DAKOTA)",
      subtitle: "Annuity principles · NAIC Best Interest · MEC rules · 1035 exchange",
      blocks: [
        { type: "heading", text: "Annuity & Tax Principles" },
        { type: "table", rows: [
    ...
    master_numbers_drill: {
      title: "SOUTH DAKOTA MASTER NUMBERS DRILL",
      subtitle: "Key numbers and time periods for South Dakota Life Producer exam",
      blocks: [
        { type: "heading", text: "South Dakota Numbers" },
        { type: "table", rows: [
          { label: "Passing Score", value: "70%", description: "Minimum passing score." },
          { label: "CE Requirement", value: "24 hours / 2 years", description: "24 CE hours biennially." }
        ]}
  ...
  /* ══════════════════════════════════════════════════════════
     ...
     ══════════════════════════════════════════════════════════ */
  ut_life_producer: {
    ut_insurance_regulation: {
      title: "UTAH INSURANCE REGULATION",
      subtitle: "Utah Insurance Code · DOI authority · licensing & CE · Guaranty Association",
      blocks: [
        { type: "heading", text: "Utah Regulatory Laws" },
        { type: "table", rows: [
          { label: "Licensing & CE", value: "24 hours / 2 years", description: "24 CE hours including 3 hours of Ethics biennially." },
          { label: "Unfair Trade Practices", value: "Rebating & Twisting prohibited", description: "Utah Unfair Trade Practices Act." },
          { label: "Guaranty Association", value: "State Protection Fund", description: "Protects policyholders against insolvent insurers. Sales mention strictly illegal." }
        ]}
      ]
    },
    general_insurance_concepts: {
      title: "GENERAL INSURANCE CONCEPTS (UTAH)",
      subtitle: "Contract mechanics · insurable interest · risk management",
      blocks: [
        { type: "heading", text: "Core Concepts" },
        { type: "table", rows: [
    ...
    life_insurance_products_and_provisions: {
      title: "UT LIFE PRODUCTS & PROVISIONS",
      subtitle: "Standard provisions · 10-day free look · nonforfeiture",
      blocks: [
        { type: "heading", text: "Standard Provisions" },
        { type: "table", rows: [
    ...
    annuities_and_federal_tax: {
      title: "ANNUITIES & FEDERAL TAX (UTAH)",
      subtitle: "Annuity principles · NAIC Best Interest · MEC rules · 1035 exchange",
      blocks: [
        { type: "heading", text: "Annuity & Tax Principles" },
        { type: "table", rows: [
    ...
    master_numbers_drill: {
      title: "UTAH MASTER NUMBERS DRILL",
      subtitle: "Key numbers and time periods for Utah Life Producer exam",
      blocks: [
        { type: "heading", text: "Utah Numbers" },
        { type: "table", rows: [
          { label: "Passing Score", value: "70%", description: "Minimum passing score." },
          { label: "CE Requirement", value: "24 hours / 2 years", description: "24 CE hours biennially." }
        ]}
  ...
  /* ══════════════════════════════════════════════════════════
     VERMONT LIFE PRODUCER
     ══════════════════════════════════════════════════════════ */
  vt_life_producer: {
    vt_insurance_regulation: {
      title: "VERMONT INSURANCE REGULATION",
      subtitle: "Vermont Insurance Code · DOI authority · licensing & CE · Guaranty Association",
      blocks: [
        { type: "heading", text: "Vermont Regulatory Laws" },
        { type: "table", rows: [
          { label: "Licensing & CE", value: "24 hours / 2 years", description: "24 CE hours including 3 hours of Ethics biennially." },
          { label: "Unfair Trade Practices", value: "Rebating & Twisting prohibited", description: "Vermont Unfair Trade Practices Act." },
          { label: "Guaranty Association", value: "State Protection Fund", description: "Protects policyholders against insolvent insurers. Sales mention strictly illegal." }
        ]}
      ]
    },
    general_insurance_concepts: {
      title: "GENERAL INSURANCE CONCEPTS (VERMONT)",
      subtitle: "Contract mechanics · insurable interest · risk management",
      blocks: [
        { type: "heading", text: "Core Concepts" },
        { type: "table", rows: [
    ...
    life_insurance_products_and_provisions: {
      title: "VT LIFE PRODUCTS & PROVISIONS",
      subtitle: "Standard provisions · 10-day free look · nonforfeiture",
      blocks: [
        { type: "heading", text: "Standard Provisions" },
        { type: "table", rows: [
    ...
    annuities_and_federal_tax: {
      title: "ANNUITIES & FEDERAL TAX (VERMONT)",
      subtitle: "Annuity principles · NAIC Best Interest · MEC rules · 1035 exchange",
      blocks: [
        { type: "heading", text: "Annuity & Tax Principles" },
        { type: "table", rows: [
    ...
    master_numbers_drill: {
      title: "VERMONT MASTER NUMBERS DRILL",
      subtitle: "Key numbers and time periods for Vermont Life Producer exam",
      blocks: [
        { type: "heading", text: "Vermont Numbers" },
        { type: "table", rows: [
          { label: "Passing Score", value: "70%", description: "Minimum passing score." },
          { label: "CE Requirement", value: "24 hours / 2 years", description: "24 CE hours biennially." }
        ]}
  ...
  /* ══════════════════════════════════════════════════════════
     ...
     ══════════════════════════════════════════════════════════ */
  wa_life_producer: {
    wa_insurance_regulation: {
      title: "WASHINGTON INSURANCE REGULATION",
      subtitle: "Washington Insurance Code · DOI authority · licensing & CE · Guaranty Association",
      blocks: [
        { type: "heading", text: "Washington Regulatory Laws" },
        { type: "table", rows: [
          { label: "Licensing & CE", value: "24 hours / 2 years", description: "24 CE hours including 3 hours of Ethics biennially." },
          { label: "Unfair Trade Practices", value: "Rebating & Twisting prohibited", description: "Washington Unfair Trade Practices Act." },
          { label: "Guaranty Association", value: "State Protection Fund", description: "Protects policyholders against insolvent insurers. Sales mention strictly illegal." }
        ]}
      ]
    },
    general_insurance_concepts: {
      title: "GENERAL INSURANCE CONCEPTS (WASHINGTON)",
      subtitle: "Contract mechanics · insurable interest · risk management",
      blocks: [
        { type: "heading", text: "Core Concepts" },
        { type: "table", rows: [
    ...
    life_insurance_products_and_provisions: {
      title: "WA LIFE PRODUCTS & PROVISIONS",
      subtitle: "Standard provisions · 10-day free look · nonforfeiture",
      blocks: [
        { type: "heading", text: "Standard Provisions" },
        { type: "table", rows: [
    ...
    annuities_and_federal_tax: {
      title: "ANNUITIES & FEDERAL TAX (WASHINGTON)",
      subtitle: "Annuity principles · NAIC Best Interest · MEC rules · 1035 exchange",
      blocks: [
        { type: "heading", text: "Annuity & Tax Principles" },
        { type: "table", rows: [
    ...
    master_numbers_drill: {
      title: "WASHINGTON MASTER NUMBERS DRILL",
      subtitle: "Key numbers and time periods for Washington Life Producer exam",
      blocks: [
        { type: "heading", text: "Washington Numbers" },
        { type: "table", rows: [
          { label: "Passing Score", value: "70%", description: "Minimum passing score." },
          { label: "CE Requirement", value: "24 hours / 2 years", description: "24 CE hours biennially." }
        ]}
  ...
  /* ══════════════════════════════════════════════════════════
     WEST VIRGINIA LIFE PRODUCER
     ══════════════════════════════════════════════════════════ */
  wv_life_producer: {
    wv_insurance_regulation: {
      title: "WEST VIRGINIA INSURANCE REGULATION",
      subtitle: "West Virginia Insurance Code · DOI authority · licensing & CE · Guaranty Association",
      blocks: [
        { type: "heading", text: "West Virginia Regulatory Laws" },
        { type: "table", rows: [
          { label: "Licensing & CE", value: "24 hours / 2 years", description: "24 CE hours including 3 hours of Ethics biennially." },
          { label: "Unfair Trade Practices", value: "Rebating & Twisting prohibited", description: "West Virginia Unfair Trade Practices Act." },
          { label: "Guaranty Association", value: "State Protection Fund", description: "Protects policyholders against insolvent insurers. Sales mention strictly illegal." }
        ]}
      ]
    },
    general_insurance_concepts: {
      title: "GENERAL INSURANCE CONCEPTS (WEST VIRGINIA)",
      subtitle: "Contract mechanics · insurable interest · risk management",
      blocks: [
        { type: "heading", text: "Core Concepts" },
        { type: "table", rows: [
    ...
    life_insurance_products_and_provisions: {
      title: "WV LIFE PRODUCTS & PROVISIONS",
      subtitle: "Standard provisions · 10-day free look · nonforfeiture",
      blocks: [
        { type: "heading", text: "Standard Provisions" },
        { type: "table", rows: [
    ...
    annuities_and_federal_tax: {
      title: "ANNUITIES & FEDERAL TAX (WEST VIRGINIA)",
      subtitle: "Annuity principles · NAIC Best Interest · MEC rules · 1035 exchange",
      blocks: [
        { type: "heading", text: "Annuity & Tax Principles" },
        { type: "table", rows: [
    ...
    master_numbers_drill: {
      title: "WEST VIRGINIA MASTER NUMBERS DRILL",
      subtitle: "Key numbers and time periods for West Virginia Life Producer exam",
      blocks: [
        { type: "heading", text: "West Virginia Numbers" },
        { type: "table", rows: [
          { label: "Passing Score", value: "70%", description: "Minimum passing score." },
          { label: "CE Requirement", value: "24 hours / 2 years", description: "24 CE hours biennially." }
        ]}
  ...
  /* ══════════════════════════════════════════════════════════
     WISCONSIN LIFE PRODUCER
     ══════════════════════════════════════════════════════════ */
  wi_life_producer: {
    wi_insurance_regulation: {
      title: "WISCONSIN INSURANCE REGULATION",
      subtitle: "Wisconsin Insurance Code · DOI authority · licensing & CE · Guaranty Association",
      blocks: [
        { type: "heading", text: "Wisconsin Regulatory Laws" },
        { type: "table", rows: [
          { label: "Licensing & CE", value: "24 hours / 2 years", description: "24 CE hours including 3 hours of Ethics biennially." },
          { label: "Unfair Trade Practices", value: "Rebating & Twisting prohibited", description: "Wisconsin Unfair Trade Practices Act." },
          { label: "Guaranty Association", value: "State Protection Fund", description: "Protects policyholders against insolvent insurers. Sales mention strictly illegal." }
        ]}
      ]
    },
    general_insurance_concepts: {
      title: "GENERAL INSURANCE CONCEPTS (WISCONSIN)",
      subtitle: "Contract mechanics · insurable interest · risk management",
      blocks: [
        { type: "heading", text: "Core Concepts" },
        { type: "table", rows: [
    ...
    life_insurance_products_and_provisions: {
      title: "WI LIFE PRODUCTS & PROVISIONS",
      subtitle: "Standard provisions · 10-day free look · nonforfeiture",
      blocks: [
        { type: "heading", text: "Standard Provisions" },
        { type: "table", rows: [
    ...
    annuities_and_federal_tax: {
      title: "ANNUITIES & FEDERAL TAX (WISCONSIN)",
      subtitle: "Annuity principles · NAIC Best Interest · MEC rules · 1035 exchange",
      blocks: [
        { type: "heading", text: "Annuity & Tax Principles" },
        { type: "table", rows: [
    ...
    master_numbers_drill: {
      title: "WISCONSIN MASTER NUMBERS DRILL",
      subtitle: "Key numbers and time periods for Wisconsin Life Producer exam",
      blocks: [
        { type: "heading", text: "Wisconsin Numbers" },
        { type: "table", rows: [
          { label: "Passing Score", value: "70%", description: "Minimum passing score." },
          { label: "CE Requirement", value: "24 hours / 2 years", description: "24 CE hours biennially." }
        ]}
  ...
  /* ══════════════════════════════════════════════════════════
     WYOMING LIFE PRODUCER
     ══════════════════════════════════════════════════════════ */
  wy_life_producer: {
    wy_insurance_regulation: {
      title: "WYOMING INSURANCE REGULATION",
      subtitle: "Wyoming Insurance Code · DOI authority · licensing & CE · Guaranty Association",
      blocks: [
        { type: "heading", text: "Wyoming Regulatory Laws" },
        { type: "table", rows: [
          { label: "Licensing & CE", value: "24 hours / 2 years", description: "24 CE hours including 3 hours of Ethics biennially." },
          { label: "Unfair Trade Practices", value: "Rebating & Twisting prohibited", description: "Wyoming Unfair Trade Practices Act." },
          { label: "Guaranty Association", value: "State Protection Fund", description: "Protects policyholders against insolvent insurers. Sales mention strictly illegal." }
        ]}
      ]
    },
    general_insurance_concepts: {
      title: "GENERAL INSURANCE CONCEPTS (WYOMING)",
      subtitle: "Contract mechanics · insurable interest · risk management",
      blocks: [
        { type: "heading", text: "Core Concepts" },
        { type: "table", rows: [
    ...
    life_insurance_products_and_provisions: {
      title: "WY LIFE PRODUCTS & PROVISIONS",
      subtitle: "Standard provisions · 10-day free look · nonforfeiture",
      blocks: [
        { type: "heading", text: "Standard Provisions" },
        { type: "table", rows: [
    ...
    annuities_and_federal_tax: {
      title: "ANNUITIES & FEDERAL TAX (WYOMING)",
      subtitle: "Annuity principles · NAIC Best Interest · MEC rules · 1035 exchange",
      blocks: [
        { type: "heading", text: "Annuity & Tax Principles" },
        { type: "table", rows: [
    ...
    master_numbers_drill: {
      title: "WYOMING MASTER NUMBERS DRILL",
      subtitle: "Key numbers and time periods for Wyoming Life Producer exam",
      blocks: [
        { type: "heading", text: "Wyoming Numbers" },
        { type: "table", rows: [
          { label: "Passing Score", value: "70%", description: "Minimum passing score." },
          { label: "CE Requirement", value: "24 hours / 2 years", description: "24 CE hours biennially." }
        ]}
  ...
  al: null, ak: null, ar: null, ct: null, de: null, dc: null, hi: null, id: null, in: null, ia: null, ks: null, ky: null, la: null, me: null, ms: null, mt: null, ne: null, nv: null, nh: null, nm: null, nd: null, ok: null, or: null, ri: null, sc: null, sd: null, ut: null, vt: null, wa: null, wv: null, wi: null, wy: null,

  /* ══════════════════════════════════════════════════════════
     MICHIGAN LIFE PRODUCER (PSI)
     ══════════════════════════════════════════════════════════ */
  mi_life_producer: {
    michigan_insurance_regulation: { title: "MICHIGAN INSURANCE REGULATION", subtitle: "MCL Chapter 500 · DIFS Director", blocks: [{ type: "heading", text: "MI Laws" }, { type: "table", rows: [{ label: "CE Requirement", value: "24 hours / 2 years", description: "24 CE hours biennially." }] }] },
    general_insurance_concepts: { title: "GENERAL INSURANCE CONCEPTS (MICHIGAN)", subtitle: "Contract mechanics", blocks: [{ type: "heading", text: "Concepts" }, { type: "table", rows: [{ label: "Contract Law", value: "Adhesion", description: "Standard principles." }] }] },
    life_insurance_products_and_provisions: { title: "MI LIFE PRODUCTS & PROVISIONS", subtitle: "Provisions · free look", blocks: [{ type: "heading", text: "Provisions" }, { type: "table", rows: [{ label: "Free Look", value: "10 days", description: "Standard review." }] }] },
    annuities_and_federal_tax: { title: "ANNUITIES & FEDERAL TAX (MICHIGAN)", subtitle: "Annuities · tax", blocks: [{ type: "heading", text: "Annuities" }, { type: "table", rows: [{ label: "Suitability", value: "Best Interest", description: "MI rules." }] }] },
    master_numbers_drill: { title: "MICHIGAN MASTER NUMBERS DRILL", subtitle: "Key limits for MI exam", blocks: [{ type: "heading", text: "MI Limits" }, { type: "table", rows: [{ label: "Passing Score", value: "70%", description: "PSI MI score." }] }] }
  },

  /* ══════════════════════════════════════════════════════════
     MASSACHUSETTS LIFE PRODUCER (PEARSON VUE)
     ══════════════════════════════════════════════════════════ */
  ma_life_producer: {
    massachusetts_insurance_regulation: { title: "MASSACHUSETTS INSURANCE REGULATION", subtitle: "M.G.L. Ch 175 · DOI Commissioner", blocks: [{ type: "heading", text: "MA Laws" }, { type: "table", rows: [{ label: "CE Requirement", value: "24 hours / 2 years", description: "24 CE hours biennially." }] }] },
    general_insurance_concepts: { title: "GENERAL INSURANCE CONCEPTS (MASSACHUSETTS)", subtitle: "Contract mechanics", blocks: [{ type: "heading", text: "Concepts" }, { type: "table", rows: [{ label: "Insurable Interest", value: "Required", description: "At application." }] }] },
    life_insurance_products_and_provisions: { title: "MA LIFE PRODUCTS & PROVISIONS", subtitle: "Provisions · free look", blocks: [{ type: "heading", text: "Provisions" }, { type: "table", rows: [{ label: "Free Look", value: "10 days", description: "Standard review." }] }] },
    annuities_and_tax_concepts: { title: "ANNUITIES & TAX CONCEPTS (MASSACHUSETTS)", subtitle: "Annuities · tax", blocks: [{ type: "heading", text: "Annuities" }, { type: "table", rows: [{ label: "Suitability", value: "Best Interest", description: "MA rules." }] }] },
    master_numbers_drill: { title: "MASSACHUSETTS MASTER NUMBERS DRILL", subtitle: "Key limits for MA exam", blocks: [{ type: "heading", text: "MA Limits" }, { type: "table", rows: [{ label: "Passing Score", value: "70%", description: "Pearson VUE score." }] }] }
  },

  /* ══════════════════════════════════════════════════════════
     MARYLAND LIFE PRODUCER (PSI)
     ══════════════════════════════════════════════════════════ */
  md_life_producer: {
    maryland_insurance_regulation: { title: "MARYLAND INSURANCE REGULATION", subtitle: "MD Code Title 10 · MIA Commissioner", blocks: [{ type: "heading", text: "MD Laws" }, { type: "table", rows: [{ label: "CE Requirement", value: "24 hours / 2 years", description: "24 CE hours biennially." }] }] },
    general_insurance_concepts: { title: "GENERAL INSURANCE CONCEPTS (MARYLAND)", subtitle: "Contract mechanics", blocks: [{ type: "heading", text: "Concepts" }, { type: "table", rows: [{ label: "Contract Law", value: "Adhesion", description: "Standard principles." }] }] },
    life_insurance_products_and_provisions: { title: "MD LIFE PRODUCTS & PROVISIONS", subtitle: "Provisions · free look", blocks: [{ type: "heading", text: "Provisions" }, { type: "table", rows: [{ label: "Free Look", value: "10 days", description: "Standard review." }] }] },
    annuities_and_tax_concepts: { title: "ANNUITIES & TAX CONCEPTS (MARYLAND)", subtitle: "Annuities · tax", blocks: [{ type: "heading", text: "Annuities" }, { type: "table", rows: [{ label: "Suitability", value: "Best Interest", description: "MD rules." }] }] },
    master_numbers_drill: { title: "MARYLAND MASTER NUMBERS DRILL", subtitle: "Key limits for MD exam", blocks: [{ type: "heading", text: "MD Limits" }, { type: "table", rows: [{ label: "Passing Score", value: "70%", description: "PSI MD score." }] }] }
  },

  /* ══════════════════════════════════════════════════════════
     MINNESOTA LIFE PRODUCER (PEARSON VUE)
     ══════════════════════════════════════════════════════════ */
  mn_life_producer: {
    minnesota_insurance_regulation: { title: "MINNESOTA INSURANCE REGULATION", subtitle: "MN Statute Ch 60K · DOC Commissioner", blocks: [{ type: "heading", text: "MN Laws" }, { type: "table", rows: [{ label: "CE Requirement", value: "24 hours / 2 years", description: "24 CE hours biennially." }] }] },
    general_insurance_concepts: { title: "GENERAL INSURANCE CONCEPTS (MINNESOTA)", subtitle: "Contract mechanics", blocks: [{ type: "heading", text: "Concepts" }, { type: "table", rows: [{ label: "Insurable Interest", value: "Required", description: "At application." }] }] },
    life_insurance_products_and_provisions: { title: "MN LIFE PRODUCTS & PROVISIONS", subtitle: "Provisions · free look", blocks: [{ type: "heading", text: "Provisions" }, { type: "table", rows: [{ label: "Free Look", value: "10 days", description: "Standard review." }] }] },
    annuities_and_tax_concepts: { title: "ANNUITIES & TAX CONCEPTS (MINNESOTA)", subtitle: "Annuities · tax", blocks: [{ type: "heading", text: "Annuities" }, { type: "table", rows: [{ label: "Suitability", value: "Best Interest", description: "MN rules." }] }] },
    master_numbers_drill: { title: "MINNESOTA MASTER NUMBERS DRILL", subtitle: "Key limits for MN exam", blocks: [{ type: "heading", text: "MN Limits" }, { type: "table", rows: [{ label: "Passing Score", value: "70%", description: "Pearson VUE score." }] }] }
  },

  /* ══════════════════════════════════════════════════════════
     COLORADO LIFE PRODUCER (PEARSON VUE)
     ══════════════════════════════════════════════════════════ */
  co_life_producer: {
    colorado_insurance_regulation: { title: "COLORADO INSURANCE REGULATION", subtitle: "CRS Title 10 · DORA Commissioner", blocks: [{ type: "heading", text: "CO Laws" }, { type: "table", rows: [{ label: "CE Requirement", value: "24 hours / 2 years", description: "24 CE hours biennially." }] }] },
    general_insurance_concepts: { title: "GENERAL INSURANCE CONCEPTS (COLORADO)", subtitle: "Contract mechanics", blocks: [{ type: "heading", text: "Concepts" }, { type: "table", rows: [{ label: "Contract Law", value: "Adhesion", description: "Standard principles." }] }] },
    life_insurance_products_and_provisions: { title: "CO LIFE PRODUCTS & PROVISIONS", subtitle: "Provisions · free look", blocks: [{ type: "heading", text: "Provisions" }, { type: "table", rows: [{ label: "Free Look", value: "15 days", description: "CO 15-day free look." }] }] },
    annuities_and_tax_concepts: { title: "ANNUITIES & TAX CONCEPTS (COLORADO)", subtitle: "Annuities · tax", blocks: [{ type: "heading", text: "Annuities" }, { type: "table", rows: [{ label: "Suitability", value: "Best Interest", description: "CO rules." }] }] },
    master_numbers_drill: { title: "COLORADO MASTER NUMBERS DRILL", subtitle: "Key limits for CO exam", blocks: [{ type: "heading", text: "CO Limits" }, { type: "table", rows: [{ label: "Passing Score", value: "70%", description: "Pearson VUE score." }] }] }
  },

  /* ══════════════════════════════════════════════════════════
     TENNESSEE LIFE PRODUCER (PEARSON VUE)
     ══════════════════════════════════════════════════════════ */
  tn_life_producer: {
    tennessee_insurance_regulation: { title: "TENNESSEE INSURANCE REGULATION", subtitle: "TCA Title 56 · TDCI Commissioner", blocks: [{ type: "heading", text: "TN Laws" }, { type: "table", rows: [{ label: "CE Requirement", value: "24 hours / 2 years", description: "24 CE hours biennially." }] }] },
    general_insurance_concepts: { title: "GENERAL INSURANCE CONCEPTS (TENNESSEE)", subtitle: "Contract mechanics", blocks: [{ type: "heading", text: "Concepts" }, { type: "table", rows: [{ label: "Insurable Interest", value: "Required", description: "At application." }] }] },
    life_insurance_products_and_provisions: { title: "TN LIFE PRODUCTS & PROVISIONS", subtitle: "Provisions · free look", blocks: [{ type: "heading", text: "Provisions" }, { type: "table", rows: [{ label: "Free Look", value: "10 days", description: "Standard review." }] }] },
    annuities_and_tax_concepts: { title: "ANNUITIES & TAX CONCEPTS (TENNESSEE)", subtitle: "Annuities · tax", blocks: [{ type: "heading", text: "Annuities" }, { type: "table", rows: [{ label: "Suitability", value: "Best Interest", description: "TN rules." }] }] },
    master_numbers_drill: { title: "TENNESSEE MASTER NUMBERS DRILL", subtitle: "Key limits for TN exam", blocks: [{ type: "heading", text: "TN Limits" }, { type: "table", rows: [{ label: "Passing Score", value: "70%", description: "Pearson VUE score." }] }] }
  },

  /* ══════════════════════════════════════════════════════════
     MISSOURI LIFE PRODUCER (PEARSON VUE)
     ══════════════════════════════════════════════════════════ */
  mo_life_producer: {
    missouri_insurance_regulation: { title: "MISSOURI INSURANCE REGULATION", subtitle: "RSMo Ch 375 · DCI Director", blocks: [{ type: "heading", text: "MO Laws" }, { type: "table", rows: [{ label: "CE Requirement", value: "24 hours / 2 years", description: "24 CE hours biennially." }] }] },
    general_insurance_concepts: { title: "GENERAL INSURANCE CONCEPTS (MISSOURI)", subtitle: "Contract mechanics", blocks: [{ type: "heading", text: "Concepts" }, { type: "table", rows: [{ label: "Contract Law", value: "Adhesion", description: "Standard principles." }] }] },
    life_insurance_products_and_provisions: { title: "MO LIFE PRODUCTS & PROVISIONS", subtitle: "Provisions · free look", blocks: [{ type: "heading", text: "Provisions" }, { type: "table", rows: [{ label: "Free Look", value: "10 days", description: "Standard review." }] }] },
    annuities_and_tax_concepts: { title: "ANNUITIES & TAX CONCEPTS (MISSOURI)", subtitle: "Annuities · tax", blocks: [{ type: "heading", text: "Annuities" }, { type: "table", rows: [{ label: "Suitability", value: "Best Interest", description: "MO rules." }] }] },
    master_numbers_drill: { title: "MISSOURI MASTER NUMBERS DRILL", subtitle: "Key limits for MO exam", blocks: [{ type: "heading", text: "MO Limits" }, { type: "table", rows: [{ label: "Passing Score", value: "70%", description: "Pearson VUE score." }] }] }
  },
  mi: null, ma: null, md: null, mn: null, co: null, tn: null, mo: null,
