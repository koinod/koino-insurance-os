...
(function () {
  ...
  const DEFAULTS = {
    ...
    // Owner override slice of producer comp. Used by ROI explorer to
    // project net-to-owner. Default 22% is the industry baseline; owner
    // can recalibrate from Settings -> Compensation (TODO) or the system
    // can learn it from actual commissions / producer comp once enough
    // records exist.
    override_pct: 0.22,
  };
  ...
  function mergeWithDefaults(partial) {
    return {
      ...
      override_pct: partial.override_pct || DEFAULTS.override_pct,
    };
  }
